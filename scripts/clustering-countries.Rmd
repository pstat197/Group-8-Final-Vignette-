...
k_hclust <- function(.df, k) {
  .df %>%
    ...
    dist() %>%   # get the Euclidean distance between rows
...
rename_countries <- function(.df) {
  .df %>%
    # replace original country names with other country names (important for the plot_map function()!)
...
plot_map <- function(.df) {
  world <- map_data("world") # dataframe containing information on world countries
...
```{r}
# dataframe containing information on world countries
